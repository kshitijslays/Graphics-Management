      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md border border-[#e0e0e0]">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-sm text-[#800000] hover:underline">
              Forgot password?
            </a>
          </div>
          ...
          <button 
            type="submit"
            className="w-full bg-[#800000] text-white py-3 px-4 rounded-lg font-medium hover:bg-[#6a0000] transition duration-300 shadow-md"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <a href="/signup" className="text-[#800000] font-medium hover:underline">
            Sign up
          </a>
        </p>
      </div>
